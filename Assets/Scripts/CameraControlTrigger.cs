...
public class MyScriptEditor: Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        if (cameraControlTrigger.customInspectorObjects.swapCameras)
        {
            ...
            cameraControlTrigger.customInspectorObjects.cameraOnLeft = EditorGUILayout.ObjectField("Camera on Right", cameraControlTrigger.customInspectorObjects.cameraOnRight,typeof(CinemachineVirtualCamera), true) as CinemachineVirtualCamera;
        }
        ...
        if(cameraControlTrigger.customInspectorObjects.panCameraOnContact)
        {
            ...
            cameraControlTrigger.customInspectorObjects.panTime = EditorGUILayout.FloatField("Pan Distance", cameraControlTrigger.customInspectorObjects.panDistance);
